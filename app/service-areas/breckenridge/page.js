    ...
    description: (
      <>
        <p className="text-base leading-7 text-gray-700 mt-6">
          ...
          belongings with the respect they deserve. Our Breckenridge movers are
          trained to handle everything from delicate heirlooms to bulky
                ...
                <ol className="flex items-center space-x-4">
                  ...
                  <li>
                    <div className="flex items-center">
                      ...
                      />
                      <Link
                        href="/service-areas/breckenridge"
                        className="ml-4 text-sm font-medium text-gray-600 hover:text-gray-700"
                      >
                        Breckenridge
                      </Link>
          ...
          <div className="mt-10 sm:mt-20">
            ...
            <div className="mt-10 sm:mt-20">
              ...
              <p className="text-base leading-7 text-gray-700 mt-6">
                ...
                <Link
                  href="https://greenmtnmovers.com/service-areas/brighton"
                  className="custom-link"
                >
                  Brighton
                </Link>{" "}
