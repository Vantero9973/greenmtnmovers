...
import castlePinesImage from "../../../public/media/movers.jpg";
    ...
    <>
      ...
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="castlepines" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Moving Services in Castle Pines, Colorado
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Trusted Castle Pines Moving Company - Local & Long-Distance
                  Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Castle Pines,
                  CO moving company. We are dedicated to providing top-notch
                  moving services to the beautiful city of Castle Pines and its
                ...
                <p className="text-gray-700">
                  Castle Pines is known for its scenic beauty, serene
                  neighborhoods, and friendly community. Our Castle Pines moving
                  services are designed to cater to the specific needs of this
                  picturesque city.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that every move is
                  unique. Whether you're moving to or from Castle Pines, our
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Castle Pines, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Castle Pines, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Castle Pines zip
                  codes, including [Add Zip Codes]. If you're in the Castle
                  Pines area, Green Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Castle Pines
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in the scenic city
                  of Castle Pines, Colorado. Whether you're relocating your home
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Castle Pines Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Castle Pines residential moving services are designed to
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Castle Pines
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Castle Pines secure and efficient.
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Furniture Assembly Services in Castle Pines
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Castle Pines. Our
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Junk Hauling Services in Castle Pines
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Castle Pines to help you
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  More About Castle Pines
                </h3>
                <p className="text-gray-700">
                  Castle Pines, Colorado, is a charming town known for its
                  scenic beauty and peaceful atmosphere. Nestled in a serene
                  environment, Castle Pines offers residents a high quality of
                  life and access to outdoor recreational opportunities. Whether
                  you enjoy hiking in nearby parks, exploring local shops and
                  restaurants, or simply taking in the natural beauty, Castle
                  Pines has something for everyone. Our experienced team is here
                  to ensure a smooth transition for you and your family or
                  business, so you can fully enjoy all that Castle Pines has to
                  offer.
                </p>
              </div>
            </div>
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Castle Pines, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Castle Pines or to a
