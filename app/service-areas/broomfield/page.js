...
import broomfieldImage from "../../../public/media/movers.jpg";
    ...
    <>
      ...
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="broomfield" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Moving Services in Broomfield, Colorado
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Trusted Broomfield Moving Company - Local & Long-Distance
                  Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Broomfield, CO
                  moving company. We are dedicated to providing top-notch moving
                  services to the vibrant city of Broomfield and its surrounding
                ...
                <p className="text-gray-700">
                  Broomfield is known for its community spirit, beautiful parks,
                  and family-friendly atmosphere. Our Broomfield moving services
                  are designed to cater to the specific needs of this welcoming
                  city.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that every move is
                  unique. Whether you're moving to or from Broomfield, our team
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Broomfield, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Broomfield, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Broomfield zip codes,
                  including 80020, 80021, 80023, and more. If you're in the
                  Broomfield area, Green Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Broomfield
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in the friendly city
                  of Broomfield, Colorado. Whether you're relocating your home
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Broomfield Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Broomfield residential moving services are designed to
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Broomfield
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Broomfield secure and efficient.
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Furniture Assembly Services in Broomfield
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Broomfield. Our
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Junk Hauling Services in Broomfield
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Broomfield to help you
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                ...
                <p className="text-gray-700">
                  Broomfield, Colorado, is a welcoming city known for its
                  friendly neighborhoods, excellent schools, and outdoor
                  recreational opportunities. As you settle into your new life
                  in Broomfield, you'll have the chance to explore beautiful
                  parks, hiking trails, and community events. The city's central
                  location in the Denver metropolitan area makes it a convenient
                  and desirable place to call home. Our experienced team is here
                  to ensure a smooth transition for you and your family or
                  business, so you can fully enjoy all that Broomfield has to
                  offer.
                </p>
              </div>
            </div>
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Broomfield, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Broomfield or to a new
