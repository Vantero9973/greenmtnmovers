  ...
  return (
    <div className="divide-y divide-gray-200 rounded-lg sm:grid sm:grid-cols-3 gap-6 sm:divide-y-0 mt-10">
      {actions.map((action) => (
        <div
          key={action.title}
          className="group relative p-6 ring-1 ring-inset ring-zinc-100 shadow-xl transition-transform transform hover:scale-105 duration-300 ease-in-out rounded-lg"
        >
          <div>
