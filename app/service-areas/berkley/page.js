    ...
    <>
      ...
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="berkley" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Moving Services in Berkley, Colorado
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Trusted Berkley Moving Company - Local & Long-Distance Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Berkley, CO
                  moving company. We are dedicated to providing top-notch moving
                  services to the charming city of Berkley and its surrounding
                ...
                <p className="text-gray-700">
                  Berkley is known for its friendly community and convenient
                  location. Our Berkley moving services are designed to cater to
                  the specific needs of this welcoming city.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that every move is
                  unique. Whether you're moving to or from Berkley, our team is
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Berkley, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Berkley, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Berkley zip codes,
                  including 80212, 80221, 80260, and more. If you're in the
                  Berkley area, Green Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Berkley
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in the charming city
                  of Berkley, Colorado. Whether you're relocating your home or
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Berkley Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Berkley residential moving services are designed to make
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Berkley
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Berkley secure and efficient. Trust
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Furniture Assembly Services in Berkley
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Berkley. Our
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Junk Hauling Services in Berkley
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Berkley to help you
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                ...
                <p className="text-gray-700">
                  Berkley, Colorado, is a vibrant neighborhood located within
                  the city of Westminster. With its proximity to Denver and a
                  range of amenities, Berkley offers a comfortable and
                  convenient lifestyle. As you settle into your new life in
                  Berkley, you'll have access to parks, shops, and a close-knit
                  community. It's a great place to call home, and our
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Berkley, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Berkley or to a new
