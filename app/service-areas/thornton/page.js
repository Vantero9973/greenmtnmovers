...
import thorntonImage from "../../../public/media/movers.jpg";
    ...
    <>
        ...
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="thornton" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Moving Services in Thornton, Colorado
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Trusted Thornton Moving Company - Local & Long-Distance Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Thornton, CO
                  moving company. We are dedicated to providing top-notch moving
                  services to the vibrant city of Thornton and its surrounding
                ...
                <p className="text-gray-700">
                  Thornton is a dynamic city located in the Denver metropolitan
                  area. Our Thornton moving services are designed to cater to
                  the specific needs of this diverse community.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that every move is
                  unique. Whether you're moving to or from Thornton, our team is
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Thornton, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Thornton, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Thornton zip codes,
                  including 80229, 80233, 80241, 80260, and more. If you're in
                  the Thornton area, Green Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Thornton
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in Thornton,
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Thornton Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Thornton residential moving services are designed to make
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Thornton
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Thornton secure and efficient. Trust
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Furniture Assembly Services in Thornton
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Thornton. Our
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-xl font-semibold mt-8">
                  Junk Hauling Services in Thornton
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Thornton to help you
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                ...
                <p className="text-gray-700">
                  Thornton, Colorado, is more than just a city; it's a dynamic
                  and diverse community that holds a special place in the heart
                  of the state. Known for its cultural diversity and rich
                  history, Thornton is a city that truly embraces the spirit of
                  Colorado living. One of Thornton's standout features is its
                  vibrant cultural tapestry. It's a melting pot of cultures,
                  home to people from various backgrounds, and it celebrates
                  this diversity. As you settle into your new life in Thornton,
                  you'll have the opportunity to explore a kaleidoscope of
                  traditions, cuisines, and festivals from around the world.
                  It's a place where different cultures converge, creating a
                  unique and inclusive atmosphere. If you love the outdoors,
                  Thornton won't disappoint. The city offers an abundance of
                  recreational activities, ensuring that there's something for
                  everyone. From hiking in the nearby natural parks to enjoying
                  a day at one of the city's many golf courses or taking in the
                  arts at local galleries, Thornton has it all. Whether you're
                  moving to or from Thornton, our experienced team is here to
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Thornton, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Thornton or across the
      ...
      <div className="w-full">
        <iframe
          ...
          height="400"
          scrolling="no"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Thornton,%20CO&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
    </>
  );
