...
import lafayetteImage from "../../../public/media/movers.jpg";
...
export default function Lafayette() {
    ...
    <>
      ...
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="lafayette" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Moving Services in Lafayette, Colorado
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Trusted Lafayette Moving Company - Local & Long-Distance Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Lafayette, CO
                  moving company. We are dedicated to providing top-notch moving
                  services to the charming city of Lafayette and its surrounding
                ...
                <p className="text-gray-700">
                  Lafayette is known for its small-town charm and friendly
                  community. Our Lafayette moving services are designed to cater
                  to the specific needs of this wonderful city.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that every move is
                  unique. Whether you're moving to or from Lafayette, our team
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Lafayette, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Lafayette, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Lafayette zip codes,
                  including 80026. If you're in the Lafayette area, Green
                  Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Lafayette
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in Lafayette,
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Lafayette Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Lafayette residential moving services are designed to make
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Lafayette
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Lafayette secure and efficient.
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Furniture Assembly Services in Lafayette
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Lafayette. Our
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Junk Hauling Services in Lafayette
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Lafayette to help you
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                ...
                <p className="text-gray-700">
                  Lafayette, Colorado, is a charming city known for its thriving
                  arts scene, vibrant downtown area, and beautiful parks. With a
                  strong sense of community, Lafayette offers a welcoming
                  environment for families and businesses alike. As you settle
                  into your new life in Lafayette, you'll have the opportunity
                  to explore local festivals, dine at fantastic restaurants, and
                  enjoy the outdoor recreational opportunities that make this
                  city special. Green Mountain Movers is here to make your move
                  to or from Lafayette as smooth as possible so you can fully
                  embrace all that this wonderful community has to offer.
                </p>
              </div>
            </div>
          </section>
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Lafayette, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Lafayette or across the
      ...
      <div className="w-full">
        <iframe
          ...
          height="400"
          scrolling="no"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Lafayette,%20CO&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
    </>
  );
