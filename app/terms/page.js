    ...
    <div className="mx-auto max-w-screen-xl py-20 px-5">
      ...
      <div className="flex flex-col gap-y-5 pt-10">
        ...
        <p>
          ...
          conditions. Do not continue to use Green Mountain Movers if you do not
        ...
        <p>
          We employ the use of cookies. By accessing Green Mountain Movers, you
          agreed to use cookies in agreement with the Green Mountain Movers's
          Privacy Policy.{" "}
        </p>
        ...
        <ul className="list-disc">
          ...
          <li>Sell, rent or sub-license material from Green Mountain Movers</li>
          <li>
        ...
        <p>
          You hereby grant Green Mountain Movers a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Green Mountain Movers; and
        ...
        <p>
          ...
          sending an e-mail to Green Mountain Movers. Please include your name,
