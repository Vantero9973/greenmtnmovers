      ...
      <div className="mx-auto max-w-screen-xl py-20 px-5">
        ...
        <div className="flex flex-col gap-y-5 pt-10">
          ...
          <p>
            ...
            use of Green Mountain Movers's Website, located at{" "}
            <Link
          ...
          <p>
            ...
            conditions. Do not continue to use Green Mountain Movers if you do
          ...
          <p>
            We employ the use of cookies. By accessing Green Mountain Movers,
            you agreed to use cookies in agreement with the Green Mountain
            Movers's Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Green Mountain Movers and/or its licensors
            own the intellectual property rights for all material on Green
            Mountain Movers. All intellectual property rights are reserved. You
            may access this from Green Mountain Movers for your own personal use
            subjected to restrictions set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul className="list-disc">
            <li>Republish material from Green Mountain Movers</li>
            <li>
              Sell, rent or sub-license material from Green Mountain Movers
            </li>
            <li>
              Reproduce, duplicate or copy material from Green Mountain Movers
            </li>
            <li>Redistribute content from Green Mountain Movers</li>
          </ul>
          ...
          <p>
            ...
            Green Mountain Movers does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Green Mountain Movers,its agents
            ...
            applicable laws, Green Mountain Movers shall not be liable for the
          ...
          <p>
            Green Mountain Movers reserves the right to monitor all Comments and
          ...
          <p>
            You hereby grant Green Mountain Movers a non-exclusive license to
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Green
            Mountain Movers; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to Green Mountain Movers. Please include your
          ...
          <p>
            No use of Green Mountain Movers's logo or other artwork will be
