...
const actions = [
  {
    ...
    icon: GiHouseKeys, // Icon representing residential junk hauling
  },
  {
    ...
    icon: GiOfficeChair, // Icon representing office junk removal
  },
  {
    ...
    icon: FaRecycle, // Icon representing recycling and eco-friendly disposal
  },
  {
    ...
    icon: FaTruckLoading, // Icon representing construction debris removal
  },
  {
    ...
    icon: FaWarehouse, // Icon representing storage unit cleanout
  },
  {
    ...
    icon: FaTrashAlt, // Icon representing appliance and furniture disposal
  },
];
      ...
      {actions.map((action) => (
        ...
        >
          <div className="flex items-center">
            ...
            <action.icon
              className="h-16 w-16 text-gray-600 z-[100] ml-8"
              aria-hidden="true"
            />
          </div>
          <div className="mt-8">
