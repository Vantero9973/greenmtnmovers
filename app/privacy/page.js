...
export default function PrivacyPolicy() {
  return (
    <div className="mx-auto max-w-screen-xl py-20 px-5">
      ...
      <p className="text-sm font-light mb-10">Last updated: March 12, 2024</p>
      <div className="flex flex-col gap-y-5">
        ...
        <ul className="list-disc">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Green Mountain Movers, 856 Lee St,
              Lakewood, CO 80215.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Green Mountain Movers,
              accessible from{" "}
              <Link
        ...
        <ul>
          <li>
            ...
            <Link
              href="https://greenmtnmovers.com/contact"
              rel="external nofollow noopener"
              target="_blank"
              className="custom-link"
            >
              https://greenmtnmovers.com/contact
            </Link>
          </li>
        </ul>
      </div>
