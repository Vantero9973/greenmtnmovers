...
import wheatRidgeImage from "../../../public/media/movers.jpg";
...
export default function WheatRidge() {
    ...
    <>
      ...
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="wheat-ridge" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Moving Services in Wheat Ridge, Colorado
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Trusted Wheat Ridge Moving Company - Local & Long-Distance
                  Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Wheat Ridge, CO
                  moving company. We are dedicated to providing top-notch moving
                  services to the vibrant city of Wheat Ridge and its
                ...
                <p className="text-gray-700">
                  Wheat Ridge is a charming city located in the Denver
                  metropolitan area. Our Wheat Ridge moving services are
                  designed to cater to the specific needs of this welcoming
                  community.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that every move is
                  unique. Whether you're moving to or from Wheat Ridge, our team
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Wheat Ridge, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Wheat Ridge, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Wheat Ridge zip codes,
                  including 80033, 80212, 80214, 80215, and more. If you're in
                  the Wheat Ridge area, Green Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Wheat Ridge
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in Wheat Ridge,
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Wheat Ridge Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Wheat Ridge residential moving services are designed to
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Wheat Ridge
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Wheat Ridge secure and efficient.
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Furniture Assembly Services in Wheat Ridge
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Wheat Ridge. Our
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-xl font-semibold mt-8">
                  Junk Hauling Services in Wheat Ridge
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Wheat Ridge to help you
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  More About Wheat Ridge
                </h3>
                <p className="text-gray-700">
                  Wheat Ridge, Colorado, is more than just a city; it's a
                  dynamic and diverse community that holds a special place in
                  the heart of the state. Known for its cultural diversity and
                  rich history, Wheat Ridge is a city that truly embraces the
                  spirit of Colorado living. One of Wheat Ridge's standout
                  ...
                  Wheat Ridge, you'll have the opportunity to explore a
                  ...
                  love the outdoors, Wheat Ridge won't disappoint. The city
                  ...
                  courses or taking in the arts at local galleries, Wheat Ridge
                  has it all. Whether you're moving to or from Wheat Ridge, our
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Wheat Ridge, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Wheat Ridge or across
      ...
      <div className="w-full">
        <iframe
          ...
          height="400"
          scrolling="no"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Wheat%20Ridge,%20CO&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
    </>
  );
