    ...
    <>
          ...
          <section id="welby" className="my-10">
            ...
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                ...
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Welby, CO
                  moving company. We are dedicated to providing top-notch moving
                  services to the welcoming community of Welby and its
                ...
                <p className="text-gray-700">
                  Welby is a charming community located in Colorado's Denver
                  metropolitan area. Our Welby moving services are designed to
                  cater to the specific needs of this close-knit neighborhood.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that every move is
                  unique. Whether you're moving to or from Welby, our team is
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Welby, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Welby, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Welby zip codes,
                  including 80229, 80233, and more. If you're in the Welby area,
                  Green Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Welby
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in Welby, Colorado.
                  Whether you're relocating your home or office, we take pride
                  in offering tailored moving solutions that cater to your
                  unique needs.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Welby Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Welby residential moving services are designed to make
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Welby
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Welby secure and efficient. Trust us
                  to handle your commercial move with precision, allowing you to
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Furniture Assembly Services in Welby
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Welby. Our skilled
                  team is adept at quickly and efficiently assembling your
                  furniture, whether it's for your new home or office. We
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-xl font-semibold mt-8">
                  Junk Hauling Services in Welby
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Welby to help you declutter
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                <h3 className="text-xl font-semibold mt-8">More About Welby</h3>
                <p className="text-gray-700">
                  Welby, Colorado, is more than just a city; it's a dynamic and
                  diverse community that holds a special place in the heart of
                  the state. Known for its cultural diversity and rich history,
                  Welby is a city that truly embraces the spirit of Colorado
                  living. One of Welby's standout features is its vibrant
                  cultural tapestry. It's a melting pot of cultures, home to
                  people from various backgrounds, and it celebrates this
                  diversity. As you settle into your new life in Welby, you'll
                  have the opportunity to explore a kaleidoscope of traditions,
                  cuisines, and festivals from around the world. It's a place
                  where different cultures converge, creating a unique and
                  inclusive atmosphere. If you love the outdoors, Welby won't
                  ...
                  galleries, Welby has it all. Whether you're moving to or from
                  Welby, our experienced team is here to ensure a smooth
                  transition for you and your family or business, so you can
                  fully immerse yourself in the vibrant life that this city has
                  to offer.
                </p>
              </div>
            </div>
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Welby, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Welby or across the
            ...
            <div className="flex flex-wrap items-center gap-5">
              <div className="flex items-center gap-2 text-gray-700 text-lg">
                <BsFillTelephoneFill />
                <a href="tel:(303) 555-1234">(303) 555-1234</a>
              </div>
              <div className="flex items-center gap-2 text-gray-700 text-lg">
                <BsFillEnvelopeFill />
                <a href="mailto:info@welbymovers.com">info@welbymovers.com</a>
              </div>
            </div>
            <ContactForm />
          </div>
      ...
      <div className="w-full">
        <iframe
          ...
          height="400"
          scrolling="no"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Welby,%20CO&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
    </>
  );
