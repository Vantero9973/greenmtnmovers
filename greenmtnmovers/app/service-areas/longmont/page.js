...
import longmontImage from "../../../public/media/movers.jpg";
...
export default function Longmont() {
    ...
    <>
      ...
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="longmont" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Moving Services in Longmont, Colorado
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Trusted Longmont Moving Company - Local & Long-Distance Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Longmont, CO
                  moving company. We are dedicated to providing top-notch moving
                  services to the beautiful city of Longmont and its surrounding
                ...
                <p className="text-gray-700">
                  Longmont is known for its scenic beauty, outdoor recreational
                  opportunities, and vibrant community. Our Longmont moving
                  services are tailored to meet the specific needs of this
                  unique city.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that every move is
                  unique. Whether you're moving to or from Longmont, our team is
                  committed to providing a seamless and stress-free experience.
                  We take pride in being a part of this community and aim to
                  make your move a positive and memorable experience.
                </p>
              </div>
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Longmont, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Longmont, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Longmont zip codes,
                  including 80501, 80503, 80504, and surrounding areas. If
                  you're in the Longmont area, Green Mountain Movers has you
                  covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Longmont
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in the scenic city
                  of Longmont, Colorado. Whether you're relocating your home or
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Longmont Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Longmont residential moving services are designed to make
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Longmont
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Longmont secure and efficient. Trust
            ...
            <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
              ...
              <p className="text-gray-700">
                Longmont, Colorado, is a city renowned for its stunning mountain
                views and outdoor recreational opportunities. Whether you're
                moving to or from Longmont, our experienced team is here to
                ensure a smooth transition for you and your family or business,
                so you can fully enjoy the beauty and opportunities this city
                has to offer.
              </p>
            </div>
          </section>
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Longmont, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Longmont or to another
            ...
            <div className="flex flex-wrap items-center gap-5">
              ...
              <div className="flex items-center gap-2 text-gray-700 text-lg">
                <BsFillEnvelopeFill />
                <a href="mailto:info@longmont-movers.com">
                  info@longmont-movers.com
                </a>
              </div>
            </div>
            <ContactForm />
      ...
      <div className="w-full">
        <iframe
          ...
          height="400"
          scrolling="no"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Longmont,%20CO&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
    </>
  );
