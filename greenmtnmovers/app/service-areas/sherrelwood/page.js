...
import sherrelwoodImage from "../../../public/media/movers.jpg";
...
export default function Sherrelwood() {
    ...
    <>
      ...
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="sherrelwood" className="my-10">
            ...
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Trusted Sherrelwood Moving Company - Local & Long-Distance
                  Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Sherrelwood, CO
                  moving company. We are dedicated to providing top-notch moving
                  services to the vibrant community of Sherrelwood and its
                ...
                <p className="text-gray-700">
                  Sherrelwood is a diverse and thriving community located in the
                  Denver metropolitan area. Our Sherrelwood moving services are
                  designed to cater to the specific needs of this dynamic
                  neighborhood.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that every move is
                  unique. Whether you're moving to or from Sherrelwood, our team
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Sherrelwood, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Sherrelwood, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Sherrelwood zip codes,
                  including 80221, 80229, and more. If you're in the Sherrelwood
                  area, Green Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Sherrelwood
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in Sherrelwood,
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Sherrelwood Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Sherrelwood residential moving services are designed to
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Sherrelwood
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Sherrelwood secure and efficient.
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Furniture Assembly Services in Sherrelwood
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Sherrelwood. Our
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-xl font-semibold mt-8">
                  Junk Hauling Services in Sherrelwood
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Sherrelwood to help you
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  More About Sherrelwood
                </h3>
                <p className="text-gray-700">
                  Sherrelwood, Colorado, is a vibrant community with a welcoming
                  atmosphere. Located in Adams County, Sherrelwood offers a mix
                  of residential and commercial areas, making it an ideal place
                  for families and businesses alike. As you settle into your new
                  life in Sherrelwood, you'll have the opportunity to explore
                  its unique character and diverse culture. Our experienced team
                  is here to ensure a smooth transition for you and your family
                  or business, so you can fully embrace all that Sherrelwood has
                  to offer.
                </p>
              </div>
            </div>
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Sherrelwood, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Sherrelwood or to
            ...
            <div className="flex flex-wrap items-center gap-5">
              ...
              <div className="flex items-center gap-2 text-gray-700 text-lg">
                <BsFillEnvelopeFill />
                <a href="mailto:info@sherrelwoodmovers.com">
                  info@sherrelwoodmovers.com
                </a>
              </div>
            </div>
            <ContactForm />
      ...
      <div className="w-full">
        <iframe
          ...
          height="400"
          scrolling="no"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Sherrelwood,%20CO&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
    </>
  );
