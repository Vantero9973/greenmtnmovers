...
import edgewaterImage from "../../../public/media/movers.jpg";
    ...
    <>
      ...
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="edgewater" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Edgewater Moving Company
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Your Reliable Edgewater Movers - Local & Long-Distance Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Edgewater, CO
                  moving company. We are committed to delivering top-notch
                  moving services to the charming town of Edgewater and its
                ...
                <p className="text-gray-700">
                  Edgewater is a picturesque community located in the Denver
                  metropolitan area. Our Edgewater moving services are designed
                  to cater to the specific needs of this unique town.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that each move is
                  unique. Whether you're moving to or from Edgewater, our team
                  is dedicated to providing a seamless and hassle-free
                  experience. We have in-depth knowledge of the local
                  neighborhoods and can navigate the town's streets with ease.
                </p>
              </div>
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Edgewater, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Edgewater, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Edgewater zip codes,
                  including 80214, 80212, and more. If you're in the Edgewater
                  area, Green Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Edgewater
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in the charming town
                  of Edgewater, Colorado. Whether you're relocating your home or
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Edgewater Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Edgewater residential moving services are designed to make
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Edgewater
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Edgewater secure and efficient.
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Furniture Assembly Services in Edgewater
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Edgewater. Our
              ...
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 md:pl-5">
                <h3 className="text-xl font-semibold mt-8">
                  Junk Hauling Services in Edgewater
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Edgewater to help you
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  More About Edgewater, Colorado
                </h3>
                <p className="text-gray-700">
                  Edgewater, Colorado, is a charming town nestled along the
                  western border of Denver. Known for its small-town atmosphere
                  and proximity to the city, Edgewater offers a unique blend of
                  urban and suburban living. As you settle into your new life in
                  Edgewater, you'll have the opportunity to explore its friendly
                  community, local shops, and beautiful parks. It's a place
                  where neighbors know each other, and the sense of community is
                  strong. If you enjoy outdoor activities, Edgewater provides
                  easy access to Sloan's Lake and numerous parks for recreation.
                  Whether you're moving to or from Edgewater, our experienced
                  team is here to ensure a smooth transition for you and your
                  family or business, so you can fully enjoy the charm of this
                  town.
                </p>
              </div>
            </div>
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Edgewater, Colorado
            </h3>
            <p className="text-gray-700">
              Getting a free moving quote from Green Mountain Movers is quick
              and easy. Our dedicated business representatives are ready to
              assist you in determining the services you need, and we'll provide
              an accurate moving estimate based on your specific requirements.
              Whether you're moving within Edgewater or to a new location, our
              experienced team is here to support you. Contact us today via
              phone, email, or the convenient contact form on this page to
              request your free moving quote. We look forward to ensuring a
              successful move for you!
            </p>
            <div className="flex flex-wrap items-center gap-5">
              <div className="flex items-center gap-2 text-gray-700 text-lg">
                <BsFillTelephoneFill />
                <a href="tel:3035551234">(303) 555-1234</a>
              </div>
              <div className="flex items-center gap-2 text-gray-700 text-lg">
                <BsFillEnvelopeFill />
                <a href="mailto:info@edgewatermovers.com">
                  info@edgewatermovers.com
                </a>
              </div>
            </div>
            <ContactForm />
      ...
      <div className="w-full">
        <iframe
          ...
          height="400"
          scrolling="no"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Edgewater,%20CO&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
    </>
  );
