...
import greenwoodVillageImage from "../../../public/media/movers.jpg";
  ...
  return (
    <>
      <div className="service-areas-clippath-bg flex justify-center items-center relative h-[200px] max-md:hidden">
        ...
        >
          Greenwood Village Moving Services
        </header>
      </div>
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="greenwood-village" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Moving Services in Greenwood Village, Colorado
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Trusted Greenwood Village Moving Company - Local &
                  Long-Distance Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Greenwood
                  Village, CO moving company. We are dedicated to providing
                  top-notch moving services to the charming city of Greenwood
                  Village and its surrounding areas. Whether you're planning a
                ...
                <p className="text-gray-700">
                  Greenwood Village is known for its upscale residential
                  communities and beautiful surroundings. Our Greenwood Village
                  moving services are designed to cater to the specific needs of
                  this affluent city.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that every move is
                  unique. Whether you're moving to or from Greenwood Village,
                  our team is committed to providing a seamless and stress-free
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Greenwood Village, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Greenwood Village, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Greenwood Village zip
                  codes, including 80110, 80111, 80121, and more. If you're in
                  the Greenwood Village area, Green Mountain Movers has you
                  covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Greenwood
                  Village
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in the upscale city
                  of Greenwood Village, Colorado. Whether you're relocating your
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Greenwood Village Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Greenwood Village residential moving services are designed
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Greenwood Village
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Greenwood Village secure and
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Furniture Assembly Services in Greenwood Village
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Greenwood Village.
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-xl font-semibold mt-8">
                  Junk Hauling Services in Greenwood Village
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Greenwood Village to help
                  you declutter your space and dispose of unwanted items
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  More About Greenwood Village
                </h3>
                <p className="text-gray-700">
                  Greenwood Village, Colorado, is a picturesque suburb of Denver
                  known for its beautiful neighborhoods, parks, and thriving
                  business community. As you settle into your new life in
                  Greenwood Village, you'll have the opportunity to enjoy the
                  city's upscale shopping and dining options, as well as its
                  proximity to the great outdoors, including Cherry Creek State
                  Park. Whether you're moving to or from Greenwood Village, our
                  experienced team is here to ensure a smooth transition for you
                  and your family or business, so you can fully embrace the
                  lifestyle that this city has to offer.
                </p>
              </div>
            </div>
          </section>
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Greenwood Village, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Greenwood Village or
              across the state, our experienced team is here to assist you.
            ...
            <div className="flex flex-wrap items-center gap-5">
              ...
              <div className="flex items-center gap-2 text-gray-700 text-lg">
                <BsFillEnvelopeFill />
                <a href="mailto:info@greenmountainmovers.com">
                  info@greenmountainmovers.com
                </a>
              </div>
            </div>
            <ContactForm />
      ...
      <div className="w-full">
        <iframe
          ...
          height="400"
          scrolling="no"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Greenwood%20Village,%20CO&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
    </>
  );
