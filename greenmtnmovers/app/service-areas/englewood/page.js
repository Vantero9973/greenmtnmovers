...
import englewoodImage from "../../../public/media/movers.jpg";
    ...
    <>
      ...
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="englewood" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Englewood Moving Company
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Your Reliable Englewood Movers - Local & Long-Distance Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Englewood, CO
                  moving company. We are dedicated to delivering top-notch
                  moving services to the vibrant city of Englewood and its
                ...
                <p className="text-gray-700">
                  Englewood is a thriving city located in the Denver
                  metropolitan area. Our Englewood moving services are designed
                  to cater to the specific needs of this dynamic community.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that each move is
                  unique. Whether you're moving to or from Englewood, our team
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Englewood, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Englewood, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Englewood zip codes,
                  including 80110, 80111, 80113, and more. If you're in the
                  Englewood area, Green Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Englewood
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in the vibrant city
                  of Englewood, Colorado. Whether you're relocating your home or
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Englewood Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Englewood residential moving services are designed to make
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Englewood
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Englewood secure and efficient.
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Furniture Assembly Services in Englewood
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Englewood. Our
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-xl font-semibold mt-8">
                  Junk Hauling Services in Englewood
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Englewood to help you
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  More About Englewood, Colorado
                </h3>
                <p className="text-gray-700">
                  Englewood, Colorado, is a vibrant city known for its cultural
                  diversity and thriving community. As you settle into your new
                  life in Englewood, you'll have the opportunity to explore a
                  wide range of cultural activities, dining options, and outdoor
                  recreational opportunities. Whether you're moving to or from
                  Englewood, our experienced team is here to ensure a smooth
                  transition for you and your family or business, so you can
                  fully immerse yourself in the lively atmosphere that this city
                  has to offer.
                </p>
              </div>
            </div>
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Englewood, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Englewood or to another
      ...
      <div className="w-full">
        <iframe
          ...
          height="400"
          scrolling="no"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Englewood,%20CO&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
    </>
  );
