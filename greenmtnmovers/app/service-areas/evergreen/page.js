...
import evergreenImage from "../../../public/media/movers.jpg";
    ...
    <>
      ...
      <div className="flex justify-center items-center py-5 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <section id="evergreen" className="my-10">
            <h2 className="text-2xl font-semibold md:hidden">
              Expert Evergreen Moving Company
            </h2>
            <div className="flex max-md:flex-col-reverse items-stretch justify-between gap-5 md:gap-10 my-5">
              <div className="flex flex-col justify-start gap-3 w-full md:w-2/4 lg:w-3/5">
                <h2 className="text-2xl font-semibold max-md:hidden">
                  Your Reliable Evergreen Movers - Local & Long-Distance Moves
                </h2>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted Evergreen, CO
                  moving company. We are dedicated to delivering top-notch
                  moving services to the picturesque town of Evergreen and its
                ...
                <p className="text-gray-700">
                  Evergreen is known for its stunning natural beauty, and our
                  Evergreen moving services are designed to cater to the
                  specific needs of this idyllic community.
                </p>
                <p className="text-gray-700">
                  At Green Mountain Movers, we understand that each move is
                  unique. Whether you're moving to or from Evergreen, our team
                  is committed to providing a seamless and stress-free
                  experience. We have extensive knowledge of the local
                  neighborhoods and can navigate the scenic routes with ease.
                </p>
              </div>
            ...
            <div className="flex flex-col justify-center gap-3">
              <h3 className="text-2xl font-semibold mt-8">
                Comprehensive Moving Services in Evergreen, CO
              </h3>
              <ServiceAreasCards />
            </div>
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Evergreen, Colorado Zip Codes We Serve
                </h3>
                <p className="text-gray-700">
                  Our service area covers a wide range of Evergreen zip codes,
                  including 80439, 80437, 80433, and more. If you're in the
                  Evergreen area, Green Mountain Movers has you covered.
                </p>
              </div>
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Residential and Commercial Moving Solutions in Evergreen
                </h3>
                <p className="text-gray-700">
                  Welcome to Green Mountain Movers, your trusted partner for
                  seamless residential and commercial moves in the serene town
                  of Evergreen, Colorado. Whether you're relocating your home or
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-lg font-semibold mt-8">
                  Evergreen Residential Moving Services
                </h3>
                <p className="text-gray-700">
                  Our Evergreen residential moving services are designed to make
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-lg font-semibold mt-8">
                  Commercial Moving Expertise in Evergreen
                </h3>
                <p className="text-gray-700">
                  ...
                  your office relocation in Evergreen secure and efficient.
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pr-5">
                <h3 className="text-xl font-semibold mt-8">
                  Furniture Assembly Services in Evergreen
                </h3>
                <p className="text-gray-700">
                  In addition to our top-notch moving services, we proudly offer
                  professional furniture assembly services in Evergreen. Our
              ...
              <div className="flex flex-col justify-start gap-3 md:w-2/4 md:pl-5">
                <h3 className="text-xl font-semibold mt-8">
                  Junk Hauling Services in Evergreen
                </h3>
                <p className="text-gray-700">
                  Green Mountain Movers goes beyond just moving. We also provide
                  reliable junk hauling services in Evergreen to help you
            ...
            <div className="flex flex-wrap justify-center items-stretch">
              <div className="flex flex-col justify-start gap-3 w-full md:pr-5">
                ...
                <p className="text-gray-700">
                  Evergreen, Colorado, is a charming town nestled in the
                  foothills of the Rocky Mountains. As you settle into your new
                  life in Evergreen, you'll have the opportunity to explore the
                  town's natural beauty, including its lush forests, pristine
                  lakes, and scenic hiking trails. Whether you're moving to or
                  from Evergreen, our experienced team is here to ensure a
                  smooth transition for you and your family or business, so you
                  can fully immerse yourself in the tranquil surroundings that
      ...
      <div className="flex justify-center items-center pt-10 pb-20 px-5 md:px-10 z-1 relative bg-[#f7f7f7]">
        <div className="flex flex-col items-center justify-center max-w-screen-xl">
          <div className="flex flex-col justify-center gap-3">
            <h3 className="text-2xl font-semibold mt-8">
              Request a Free Moving Quote in Evergreen, Colorado
            </h3>
            <p className="text-gray-700">
              ...
              requirements. Whether you're moving within Evergreen or to another
            ...
            <div className="flex flex-wrap items-center gap-5">
              <div className="flex items-center gap-2 text-gray-700 text-lg">
                <BsFillTelephoneFill />
                <a href="tel:3035555678">(303) 555-5678</a>
              </div>
              <div className="flex items-center gap-2 text-gray-700 text-lg">
                <BsFillEnvelopeFill />
                <a href="mailto:info@evergreenmovers.com">
                  info@evergreenmovers.com
                </a>
              </div>
            </div>
            <ContactForm />
      ...
      <div className="w-full">
        <iframe
          ...
          height="400"
          scrolling="no"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Evergreen,%20CO&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
    </>
  );
